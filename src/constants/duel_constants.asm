...
DEF CARD_LOCATION_JUST_DRAWN   EQU $0f
...
DEF SUBSTATUS3_THIS_TURN_DOUBLE_DAMAGE   EQU 1 << SUBSTATUS3_THIS_TURN_DOUBLE_DAMAGE_F
DEF SUBSTATUS3_HEADACHE                  EQU 1 << SUBSTATUS3_HEADACHE_F
